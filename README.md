...
- 🔧 Trabajando en migraciones de sitios y builds e-commerce para clientes de [Orixo Studios](https://www.davidurdaneta.com)
- 🌱 Explorando React, Next.js, Astro y Supabase para proyectos más allá de WordPress
- 💬 Preguntame sobre WordPress, WooCommerce, Elementor, Shopify, DirectAdmin/cPanel, migraciones y performance
- 📫 Contacto: **contacto@davidurdaneta.com**
- 🌐 Portfolio: [www.davidurdaneta.com](https://www.davidurdaneta.com) (hecho en Astro)
...
- 🗣️ **LingualNova** — migración de app de idiomas de Vite/TanStack a Next.js 15, con Supabase Auth

---

<sub>⭐ Si te sirve algo de mi trabajo, dejá una estrella</sub>
